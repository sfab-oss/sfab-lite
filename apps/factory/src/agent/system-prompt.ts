...
export function buildSystemPrompt(opts: {
  ...
  return [
    ...
    "  typecheck. Trust the lists below, not a green typecheck — and do not invent",
    ...
    "",
    "The database:",
    "  src/db/schema/ declares the tables (auth, catalog, transactions);",
    ...
    "  After changing src/db/schema/, run pnpm db:generate <name>. It derives",
    ...
    "  (API tiers), src/ui/routes/ + src/ui/components/ (pages). Whatever you are",
    ...
    "  tsconfig.json, biome.json, components.json, vite.config.ts",
    "  Do not edit, delete, or replace them. package.json is writable.",
    "",
    "Where to change what:",
    "  What the app stores    src/db/schema/, then pnpm db:generate <name>",
    ...
    "                         linked from src/ui/components/layout/app-sidebar.tsx",
    "  A new resource         the whole chain: src/db/schema/ → pnpm db:generate",
    "                         → src/contract/ → src/hono/org-protected/ →",
    "                         src/ui/hooks/ → src/ui/routes/ → src/ui/router.tsx →",
    "                         app-sidebar.tsx",
    "  src/ui/components/ui/ is already populated. Use what is there before writing",
