...
export function buildSystemPrompt(opts: {
  ...
  return [
    ...
    "  A whole new page       src/routes/, registered in src/router.tsx,",
    ...
    "                         src/hooks/ → src/routes/ → src/router.tsx →",
    "                         app-sidebar.tsx",
    "  src/components/ui/ is already populated. Use what is there before writing",
