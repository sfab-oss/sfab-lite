...
import { PreviewCodePanel } from "@/components/preview/preview-code-panel";
import {
  readPreviewCodeOpen,
  writePreviewCodeOpen,
} from "@/lib/preview/code-panel-preference";
import { subscribeLive } from "@/lib/preview/live-bus";
import { appBasePath, reloadPreviewFrame } from "@/lib/preview/reload-preview";

const IFRAME_SANDBOX = "allow-same-origin allow-scripts allow-forms";

export function AppConsolePreviewPage({ appId }: { appId: string }) {
