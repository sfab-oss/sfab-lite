...
import { dirEntries, fileContent } from "@/features/chat/data/source-files";
import { FileBrowser } from "@/features/workspace-files/file-browser";
import type { WorkspaceFilesSource } from "@/features/workspace-files/types";
import { useTreeAtRef } from "@/hooks/use-code-tree";

const DEFAULT_REF = "main";

export function AppCodeScreen({ appId }: { appId: string }) {
