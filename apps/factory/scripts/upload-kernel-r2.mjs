 ...
 * real bucket.
 *
 * Discover chunks from packages/kernel/kernel.json + vendor/client/.
 */
...
const kernelJsonPath = join(repoRoot, "packages/kernel/kernel.json");
const clientDir = join(repoRoot, "packages/kernel/vendor/client");
