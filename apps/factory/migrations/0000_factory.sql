...
--> statement-breakpoint
CREATE INDEX `app_organizationId_idx` ON `app` (`organization_id`);--> statement-breakpoint
CREATE INDEX `app_status_idx` ON `app` (`status`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX `check_run_app_sha_idx` ON `check_run` (`app_id`,`sha`);--> statement-breakpoint
CREATE INDEX `check_run_pr_idx` ON `check_run` (`pr_id`);--> statement-breakpoint
CREATE INDEX `check_run_app_created_idx` ON `check_run` (`app_id`,`created_at`);--> statement-breakpoint
...
CREATE INDEX `mcp_org_grant_organizationId_idx` ON `mcp_organization_grant` (`organization_id`);--> statement-breakpoint
CREATE TABLE `member` (
	`id` text PRIMARY KEY NOT NULL,
	`organization_id` text NOT NULL,
	`user_id` text NOT NULL,
...
--> statement-breakpoint
CREATE UNIQUE INDEX `pull_request_app_number_uidx` ON `pull_request` (`app_id`,`number`);--> statement-breakpoint
CREATE INDEX `pull_request_app_status_idx` ON `pull_request` (`app_id`,`status`);--> statement-breakpoint
CREATE INDEX `pull_request_app_head_branch_idx` ON `pull_request` (`app_id`,`head_branch`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX `workspace_appId_idx` ON `workspace` (`app_id`);