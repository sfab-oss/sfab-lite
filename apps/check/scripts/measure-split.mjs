 ...
 *
 *   node scripts/measure-split.mjs        # 4 apps
 *   APPS=2 node scripts/measure-split.mjs
 */
...
const entry = join(here, "measure-split.ts");
const outDir = join(appRoot, ".tmp");
const outfile = join(outDir, "measure-split.mjs");
