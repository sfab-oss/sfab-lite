 ...
 *
 *   node scripts/measure-program.mjs        # 4 apps
 *   APPS=2 node scripts/measure-program.mjs
 */
...
const entry = join(here, "measure-program.ts");
const outDir = join(appRoot, ".tmp");
const outfile = join(outDir, "measure-program.mjs");
