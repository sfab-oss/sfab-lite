...
| Code host (R2 git stand-in) | **host-kit** (harness adapter, ADR-0014) | The framework never sees a repository; a second host brings its own code host behind the same adapter seam. |
