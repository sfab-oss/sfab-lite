...
function ErrorComponent({ error }) {
  ...
  return /* @__PURE__ */ jsxs("div", { style: { padding: ".5rem", maxWidth: "100%" }, children: [
    /* @__PURE__ */ jsxs("div", { style: { display: "flex", alignItems: "center", gap: ".5rem" }, children: [
      /* @__PURE__ */ jsx2("strong", { style: { fontSize: "1rem" }, children: "Something went wrong!" }),
      /* @__PURE__ */ jsx2(
        "button",
        {
          style: {
    ...
    /* @__PURE__ */ jsx2("div", { style: { height: ".25rem" } }),
    show ? /* @__PURE__ */ jsx2("div", { children: /* @__PURE__ */ jsx2(
      "pre",
      {
        style: {
          fontSize: ".7em",
        ...
        children: error.message ? /* @__PURE__ */ jsx2("code", { children: error.message }) : null
      }
    ) }) : null
  ] });
}
...
function createLink(Comp) {
  return React9.forwardRef(function CreatedLink(props, ref) {
    return /* @__PURE__ */ jsx4(Link, { ...props, _asChild: Comp, ref });
  });
}
...
var RouteApi = class extends BaseRouteApi {
  ...
  constructor({ id }) {
    ...
    this.Link = React__default2.forwardRef((props, ref) => {
      const router = useRouter();
      const fullPath = router.routesById[this.id].fullPath;
      return /* @__PURE__ */ jsx5(Link, { ref, from: fullPath, ...props });
    });
  }
};
var Route = class extends BaseRoute {
  ...
  constructor(options) {
    ...
    this.Link = React__default2.forwardRef(
      (props, ref) => {
        return /* @__PURE__ */ jsx5(Link, { ref, from: this.fullPath, ...props });
      }
    );
...
function renderRouteNotFound(router, route, data) {
  if (!route.options.notFoundComponent) {
    if (router.options.defaultNotFoundComponent) {
      return /* @__PURE__ */ jsx8(router.options.defaultNotFoundComponent, { data });
    }
    if (true) {
      tiny_warning_esm_default(
    ...
    return /* @__PURE__ */ jsx8(DefaultGlobalNotFound, {});
  }
...
var Match = React12.memo(function MatchImpl({
  ...
  const pendingElement = PendingComponent ? /* @__PURE__ */ jsx11(PendingComponent, {}) : null;
  ...
  return /* @__PURE__ */ jsxs2(ShellComponent, { children: [
    /* @__PURE__ */ jsx11(matchContext.Provider, { value: matchId, children: /* @__PURE__ */ jsx11(ResolvedSuspenseBoundary, { fallback: pendingElement, children: /* @__PURE__ */ jsx11(
      ResolvedCatchBoundary,
      {
        ...
        children: /* @__PURE__ */ jsx11(
          ResolvedNotFoundBoundary,
          {
            ...
            children: resolvedNoSsr || matchState._displayPending ? /* @__PURE__ */ jsx11(ClientOnly, { fallback: pendingElement, children: /* @__PURE__ */ jsx11(MatchInner, { matchId }) }) : /* @__PURE__ */ jsx11(MatchInner, { matchId })
          }
        )
      }
    ) }) }),
    parentRouteId === rootRouteId && router.options.scrollRestoration ? /* @__PURE__ */ jsxs2(Fragment2, { children: [
      /* @__PURE__ */ jsx11(OnRendered, {}),
...
var MatchInner = React12.memo(function MatchInnerImpl({
  ...
  const out = React12.useMemo(() => {
    ...
    if (Comp) {
      return /* @__PURE__ */ jsx11(Comp, {}, key);
    }
...
var Outlet = React12.memo(function OutletImpl() {
  ...
  const pendingElement = router.options.defaultPendingComponent ? /* @__PURE__ */ jsx11(router.options.defaultPendingComponent, {}) : null;
  ...
  const nextMatch = /* @__PURE__ */ jsx11(Match, { matchId: childMatchId });
  if (matchId === rootRouteId) {
    return /* @__PURE__ */ jsx11(React12.Suspense, { fallback: pendingElement, children: nextMatch });
  }
  return nextMatch;
});
...
function Matches() {
  ...
  const inner = /* @__PURE__ */ jsxs3(ResolvedSuspense, { fallback: pendingElement, children: [
    !router.isServer && /* @__PURE__ */ jsx12(Transitioner, {}),
    /* @__PURE__ */ jsx12(MatchesInner, {})
  ] });
  return router.options.InnerWrap ? /* @__PURE__ */ jsx12(router.options.InnerWrap, { children: inner }) : inner;
}
function MatchesInner() {
  ...
  return /* @__PURE__ */ jsx12(matchContext.Provider, { value: matchId, children: /* @__PURE__ */ jsx12(
    CatchBoundary,
    {
      getResetKey: () => resetKey,
      ...
      children: matchId ? /* @__PURE__ */ jsx12(Match, { matchId }) : null
    }
  ) });
}
...
function RouterContextProvider({
  ...
  const provider = /* @__PURE__ */ jsx13(routerContext2.Provider, { value: router, children });
  if (router.options.Wrap) {
    return /* @__PURE__ */ jsx13(router.options.Wrap, { children: provider });
  }
  return provider;
}
...
function Asset({
  ...
  switch (tag) {
    case "title":
      return /* @__PURE__ */ jsx14("title", { ...attrs, suppressHydrationWarning: true, children });
    case "meta":
      return /* @__PURE__ */ jsx14("meta", { ...attrs, suppressHydrationWarning: true });
    case "link":
      return /* @__PURE__ */ jsx14("link", { ...attrs, suppressHydrationWarning: true });
    case "style":
    ...
    case "script":
      return /* @__PURE__ */ jsx14(Script, { attrs, children });
    default:
      return null;
  }
}
function Script({
  ...
  if ((attrs == null ? void 0 : attrs.src) && typeof attrs.src === "string") {
    return /* @__PURE__ */ jsx14("script", { ...attrs, suppressHydrationWarning: true });
  }
  if (typeof children === "string") {
    return /* @__PURE__ */ jsx14(
      "script",
...
function HeadContent() {
  const tags = useTags();
  return tags.map((tag) => /* @__PURE__ */ createElement5(Asset, { ...tag, key: `tsr-meta-${JSON.stringify(tag)}` }));
}
...
var Scripts = () => {
  ...
  return /* @__PURE__ */ jsx15(Fragment3, { children: allScripts.map((asset, i) => /* @__PURE__ */ createElement6(Asset, { ...asset, key: `tsr-scripts-${asset.tag}-${i}` })) });
};
export {
  Asset,
  Await,
