/**
 * Install (or verify) the isolated kernel universe under packages/kernel/universe.
 *
 ...
 * cannot re-resolve optional peers from apps/* / packages/*.
 */
...
function validateUniverseManifest() {
  ...
  if (missing.length || mismatched.length || unexpected.length) {
    const lines = [
      "packages/kernel/universe/package.json is out of sync with scripts/pins.mjs:",
