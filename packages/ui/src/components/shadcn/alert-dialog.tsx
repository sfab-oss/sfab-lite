...
function AlertDialogMedia({
  ...
  return (
    <div
      className={cn(
        "mb-2 inline-flex size-10 items-center justify-center rounded-md bg-muted *:data-[slot=alert-dialog-media]:size-6 sm:group-data-[size=default]/alert-dialog-content:row-span-2 [&>svg:not([class*='size-'])]:size-6",
        className
      )}
