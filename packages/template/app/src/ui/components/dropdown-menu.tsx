...
/**
 * Open/close motion rides Base UI's `data-starting-style` /
 * `data-ending-style` rather than `animate-in` utilities: those come from
 * `tw-animate-css`, which this app's stylesheet does not import.
 */
